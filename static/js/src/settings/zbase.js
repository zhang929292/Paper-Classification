...
`);
    ...
    refresh_jwt_token() {
        setInterval(() => {
            $.ajax({
                url: "https://app165.acapp.acwing.com.cn/settings/token/refresh/",
                type: "post",
                data: {
        ...
        setTimeout(() => {
            $.ajax({
                url: "https://app165.acapp.acwing.com.cn/settings/ranklist/",
                type: "get",
                headers: {
    ...
    login_on_remote(username, password) {  // 在远程服务器上登录
        ...
        $.ajax({
            url: "https://app165.acapp.acwing.com.cn/settings/token/",
            type: "post",
            data: {
                username: username,
                password: password,
